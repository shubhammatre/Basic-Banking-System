...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><b><b><b>Phoenix Bank</b></b></b></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="transactions.php"><b>Transaction History</b></a>
        </li>
    

        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="https://www.xe.com/currencyconverter/convert/?Amount=20&From=INR&To=EUR"><b>Currency Convertor</b> </a>
        </li>
...
<div class="container">
        ...
        <br>
         ...
         <footer class="text-center mt-5 py-2">
            <p>&copy 2021 <b>Shubham Matre</b> <br>Phoenix Foundation</p>
        </footer>
